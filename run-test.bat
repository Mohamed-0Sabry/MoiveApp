@echo off
echo Starting Movie Night App in TEST mode...
d:
...
"C:\Program Files\Java\jdk-21\bin\java.exe" --module-path "C:\javafx-sdk-21.0.7\lib" --add-modules javafx.controls,javafx.fxml,javafx.media -cp target/classes com.movienight.Main --test 